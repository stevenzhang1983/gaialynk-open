...
import { ConsumerWelcomeIllustration } from "./consumer-welcome-illustration";

type Props = {
  copy: ConsumerOnboardingCopy["welcome"];
  onNext: () => void;
};

export function ConsumerWelcomeStep({ copy, onNext }: Props) {
  return (
    <div className="space-y-6">
      <ConsumerWelcomeIllustration />
