...
const COPY_BY_LOCALE: Record<Locale, Record<string, CaseItem>> = {
  en: {
    ...
    "node-collaboration": {
      ...
      description: "Collaborate across nodes while preserving governance boundaries and invocation origin traceability.",
      status: "Now",
    },
  ...
  "zh-Hant": {
    ...
    "node-collaboration": {
      title: "跨節點可信協作",
      description: "在跨節點協作中維持治理邊界，且每次調用來源可追溯。",
      status: "Now",
    },
    "autonomous-revenue-ops": {
      title: "週期自動化與增長運營",
  ...
  "zh-Hans": {
    ...
    "node-collaboration": {
      title: "跨节点可信协作",
      description: "在跨节点协作中保持治理边界，且每次调用来源可追溯。",
      status: "Now",
    },
    "autonomous-revenue-ops": {
      title: "周期自动化与增长运营",
...
export default async function UseCaseDetailPage({
  ...
  const ctaText = {
    en: { now: "Start Building", later: "Join Waitlist" },
    "zh-Hant": { now: "開始構建", later: "加入等待名單" },
    "zh-Hans": { now: "开始构建", later: "加入等待名单" },
  }[locale];
