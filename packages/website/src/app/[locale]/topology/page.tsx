...
const TOPOLOGY_COPY: Record<
  Locale,
  { title: string; description: string; seoTitle: string; seoDescription: string; tiers: { id: string; title: string; desc: string }[] }
> = {
  en: {
  ...
  return (
    <section className="space-y-8">
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        <h2 className="text-lg font-semibold">T1 → T5</h2>
