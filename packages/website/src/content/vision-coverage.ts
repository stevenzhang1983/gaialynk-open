...
export const PRODUCT_API_CAPABILITIES: Record<string, { status: CapabilityStatus; endpoint: string }> = {
  ...
  connectorAuthV1: { status: "In Progress", endpoint: "/api/v1/connectors/authorizations" },
  localActionReceiptsV1: { status: "In Progress", endpoint: "/api/v1/connectors/local-action-receipts" },
